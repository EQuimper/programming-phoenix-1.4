defmodule RumblWeb.VideoControllerTest do
  ...
  @create_attrs %{decription: "some decription", title: "some title", url: "some url"}
  @update_attrs %{decription: "some updated decription", title: "some updated title", url: "some updated url"}
  @invalid_attrs %{decription: nil, title: nil, url: nil}
  ...
  describe "update video" do
    ...
    test "redirects when data is valid", %{conn: conn, video: video} do
      ...
      assert html_response(conn, 200) =~ "some updated decription"
    end
